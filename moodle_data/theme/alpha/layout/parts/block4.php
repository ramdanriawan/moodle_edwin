            ...
            $a = format_text(theme_alpha_get_setting("block4answer" . $i),FORMAT_HTML, array('noclean' => true));
                        echo '<div class="accordion-item">';
                              echo '<h3 class="accordion-header" id="heading'.$i.'">';
                                    echo '<button class="accordion-button collapsed" type="button" data-toggle="collapse" data-target="#collapse'.$i.'" aria-expanded="false" aria-controls="collapse'.$i.'">';
                                    echo $q;
                                    echo '</button>';
                              echo '</h3>';
                              echo '<div id="collapse'.$i.'" class="accordion-collapse collapse" aria-labelledby="heading'.$i.'" data-parent="#block4Accordion">';
