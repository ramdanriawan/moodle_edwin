...
* remove folder theme/alpha/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/alpha/scss/bootstrap
...
* comment out this line in theme/alpha/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/alpha/amd/src/bootstrap (including the subfolder)
...
* in folder theme/alpha run "Grunt amd" to compile the bootstrap JS
