...
$THEME->layouts = [
    ...
    'course' => array(
        ...
        'regions' => array('side-pre', 'ctopbl', 'cbottombl', 'cstopbl', 'csbottombl', 'sidebartopblocks', 'sidebarbottomblocks'),
        'defaultregion' => 'side-pre',
    ...
    'mydashboard' => array(
        ...
        'regions' => array('side-pre', 'dtopblocks', 'dbottomblocks', 'sidebartopblocks', 'sidebarbottomblocks'),
        'defaultregion' => 'side-pre',
    ...
    // Embeded pages, like iframe/object embeded in moodleform - it needs as much alpha as possible.
    'embedded' => array(
        'file' => 'embedded.php',
        'regions' => array()
    ),
...
//$THEME->iconsystem = '\\theme_alpha\\output\\icon_system_fontawesome';
