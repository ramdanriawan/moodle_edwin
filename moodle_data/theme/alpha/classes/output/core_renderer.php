...
class core_renderer extends \core_renderer {
    ...
    */
    ...
    public function courseheadermenu() {
        ...
        if(get_config('theme_alpha', 'isitemongrades') == 1) {
            $isitemongrades = true;
        }
        if(get_config('theme_alpha', 'isitemonparticipants') == 1) {
            $isitemonparticipants = true;
        }
        if(get_config('theme_alpha', 'isitemonbadges') == 1) {
            $isitemonbadges = true;
        }
        if(get_config('theme_alpha', 'isitemoncompetencies') == 1) {
            $isitemoncompetencies = true;
        }

        if (!$isitemongrades && !$isitemonparticipants && !$isitemonbadges && !$isitemoncompetencies) {
            return false;
        }
    ...
    public function alpha_allcourseslink() {
        global $CFG;
        $allcourseicon = '';
        $allcoursetxt = format_text(theme_alpha_get_setting('stringallcourses'),FORMAT_HTML, array('noclean' => true));
    ...
    public function alpha_mycourses_heading() {
        ...
        $detailstxt = format_text(theme_alpha_get_setting('stringdetails'),FORMAT_HTML, array('noclean' => true));
    ...
    public function alpha_mycourses_heading_text() {
        ...
        $txt = format_text(theme_alpha_get_setting('stringmycourses'),FORMAT_HTML, array('noclean' => true));;
    ...
    public function alpha_mycourses() {
        ...
        $nomycoursestxt = format_text(theme_alpha_get_setting('stringnocourses'),FORMAT_HTML, array('noclean' => true));
    ...
    public function render_login_signup_form($form) {
        ...
        if (!empty($PAGE->theme->settings->customloginlogo)) {
            $url = $PAGE->theme->setting_file_url('customloginlogo', 'customloginlogo');
