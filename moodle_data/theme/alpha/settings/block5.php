...
$page = new admin_settingpage('theme_alpha_block5', get_string('settingsblock5', 'theme_alpha'));
          ...
          for ($sliderindex = 1; $sliderindex <= $slidercount; $sliderindex++) {
                    ...
                    $setting = new admin_setting_heading($name, '<span class="rui-admin-no">'. $sliderindex . '</span>'. $heading, format_text(get_string('hblock5item_desc', 'theme_alpha'), FORMAT_MARKDOWN));
                    $page->add($setting);
