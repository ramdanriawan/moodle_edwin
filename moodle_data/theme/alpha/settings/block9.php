...
$page = new admin_settingpage('theme_alpha_block9', get_string('settingsblock9', 'theme_alpha'));
          ...
          $default = 0;
          $setting = new admin_setting_configcheckbox($name, $title . '<span class="badge badge-sq badge-dark ml-2">Block #9</span>', $description, $default);
          $page->add($setting);
          ...
          $default = 'Designed for all use cases';
          ...
          $default = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Facilisi felis, et id aliquam ac tincidunt. Sapien vel tellus mattis hendrerit orci. Ut etiam nullam.';
          $setting = new admin_setting_configtextarea($name, $title, $description, $default);
          $page->add($setting);
          ...
          <div class="d-flex flex-wrap mt-4 justify-content-center w-100"><a href="https://themeforest.net/item/space-moodle-template/22579922" class="m-2 btn btn-lg btn-primary" target="_blank">Get this theme for $99*</a><a href="https://rosea.gitbook.io/space-moodle-theme/" class="m-2 btn btn-lg btn-secondary" target="_blank">Documentation</a></div>
          <hr class="hr-small">
          <p class="rui-block-text--3 mt-3">The theme is not compatible with older Alpha versions.<br>You have to set up the front page from scratch. For the older version of the Moodle, there is Alpha 1.5.x
          </p>
      ...
      <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 mx-0">
          ...
          <div class="rui-card-item col mb-4">
              <div class="rui-card">
                  <div class="rui-card-body">
                      ...
                      <a href="https://rosea.io" class="btn btn-sm btn-primary">More quick guides</a>
                  </div>
              </div>
          </div>
          <!-- End item -->
          ...
          <div class="rui-card-item col mb-4">
              <div class="rui-card">
                  <div class="rui-card-body">
                      ...
                      <p class="rui-card-text">With supporting text below as a natural lead-in to additional content.</p>
                      <a href="https://rosea.io" class="btn btn-sm btn-primary">More for teachers</a>
                  </div>
              </div>
          </div>
          <!-- End item -->
          ...
          <div class="rui-card-item col mb-4">
              <div class="rui-card">
                  <div class="rui-card-body">
                      ...
                      <p class="rui-card-text">With supporting text below as a natural lead-in to additional content.</p>
                      <a href="https://rosea.io" class="btn btn-sm btn-primary">More activities</a>
                  </div>
              </div>
          </div>
          <!-- End item -->
          ...
          <div class="rui-card-item col mb-4">
              <div class="rui-card">
                  <div class="rui-card-body">
                      ...
                      <p class="rui-card-text">With supporting text below as a natural lead-in to additional content.</p>
                      <a href="https://rosea.io" class="btn btn-sm btn-primary">New features list</a>
                  </div>
              </div>
          </div>
          <!-- End item -->
          ...
          <div class="rui-card-item col mb-4">
              <div class="rui-card">
                  <div class="rui-card-body">
                      ...
                      <p class="rui-card-text">With supporting text below as a natural lead-in to additional content.</p>
                      <a href="https://rosea.io" class="btn btn-sm btn-primary">More for administrators</a>
                  </div>
              </div>
          </div>
          <!-- End item -->
          ...
          <div class="rui-card-item col mb-4">
              <div class="rui-card">
                  <div class="rui-card-body">
                      ...
                      <p class="rui-card-text">With supporting text below as a natural lead-in to additional content.</p>
                      <a href="https://rosea.io" class="btn btn-sm btn-primary">Check out my portfolio</a>
                  </div>
              </div>
          </div>
          <!-- End item -->
          ...
          $default = '          <div class="wrapper-md mt-5 text-center">
          <hr class="hr-small" />
                         <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Facilisi felis, et id aliquam ac tincidunt. Sapien vel tellus mattis hendrerit orci. Ut etiam nullam.</p>
                    </div>';
          $setting = new admin_setting_configtextarea($name, $title, $description, $default);
          $page->add($setting);
