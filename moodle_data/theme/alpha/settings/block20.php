...
$page = new admin_settingpage('theme_alpha_block20', get_string('settingsblock20', 'theme_alpha'));
        ...
        $setting = new admin_setting_configtext($name, $title, $description, $default);
        $page->add($setting);
        $settings->hide_if('theme_alpha/sliderinterval',
        'theme_alpha/sliderintervalenabled', 'notchecked');
        ...
        $slidercount = 1;
               ...
               for ($sliderindex = 1; $sliderindex <= $slidercount; $sliderindex++) {
                        ...
                        $setting = new admin_setting_heading($name, '<span class="rui-admin-no">'. $sliderindex . '</span>'. $heading, format_text(get_string('hblock1slide_desc', 'theme_alpha'), FORMAT_MARKDOWN));
                        $page->add($setting);
