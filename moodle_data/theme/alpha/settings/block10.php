              ...
              <div class="w-lg-65 text-center mx-lg-auto">
                  ...
                  <div class="row justify-content-center align-items-center">
                      <div class="col-auto col-sm py-3">
                          <img src="https://assets.rosea.io/demofiles/alpha/block10/logo-1.svg" alt="Logo" width="200" height="67" class="img-fluid atto_image_button_text-bottom">
                      </div>
                      <!-- End Col -->
          
                      <div class="col-auto col-sm py-3">
                          <img src="https://assets.rosea.io/demofiles/alpha/block10/logo-5.svg" alt="Logo" width="140" height="47" class="img-fluid atto_image_button_text-bottom">
                      </div>
                      <!-- End Col -->
          
                      <div class="col-auto col-sm py-3">
                          <img src="https://assets.rosea.io/demofiles/alpha/block10/logo-2.svg" alt="Logo" width="110" height="28" class="img-fluid atto_image_button_text-bottom">
                      </div>
                      <!-- End Col -->
          
                      <div class="col-auto col-sm py-3">
                          <img src="https://assets.rosea.io/demofiles/alpha/block10/logo-4.svg" alt="Logo" width="140" height="47" class="img-fluid atto_image_button_text-bottom">
                      </div>
                      <!-- End Col -->
          
                      <div class="col-auto col-sm py-3">
                          <img src="https://assets.rosea.io/demofiles/alpha/block10/logo-3.svg" alt="Logo" width="140" height="47" class="img-fluid atto_image_button_text-bottom">
                      </div>
                      <!-- End Col -->
                  </div>
                  <!-- End Row -->
