...
class theme_alpha_mod_quiz_renderer extends mod_quiz_renderer {
    ...
    public function quiz_intro($quiz, $cm) {
        ...
        return html_writer::tag('div', format_module_intro('quiz', $quiz, $cm->id),
                        array('id' => 'intro'));
     ...
     public function summary_page_controls($attemptobj) {
        ...
        if ($attemptobj->get_state() == quiz_attempt::IN_PROGRESS) {
            ...
            $output .= $this->container($this->container($this->render($button),
                    'rui-controls'), 'rui-submitbtns rui-submitbtns--back');
        }
        ...
        $button = new single_button(
                ...
                get_string('submitallandfinish', 'quiz'), null,true);
...
class theme_alpha_core_question_renderer extends core_question_renderer {
    ...
    protected function info(question_attempt $qa, qbehaviour_renderer $behaviouroutput,
        ...
        $output = '';
        $output .= '<div class="d-inline-flex align-items-center flex-wrap mb-sm-2 mb-md-0">' .$this->number($number) . '<div class="d-inline-flex align-items-center flex-wrap">' . $this->status($qa, $behaviouroutput, $options) . $this->mark_summary($qa, $behaviouroutput, $options) . '</div></div>';
    ...
    protected function number($number) {
        ...
        return html_writer::tag('h4', $numbertext, array('class' => 'rui-question-no mb-sm-2 mb-md-0 mr-md-3'));
    }
    ...
    protected function status(question_attempt $qa, qbehaviour_renderer $behaviouroutput,
        ...
        return html_writer::tag('div', $qa->get_state_string($options->correctness),
                array('class' => 'state mx-md-2 mr-sm-2 my-sm-2 my-md-0'));
    }
    ...
    protected function edit_question_link(question_attempt $qa, question_display_options $options) {
        ...
        return html_writer::link($editurl, $icon, array('class' => 'btn btn-sm btn-success editquestion line-height-1 ml-sm-2'));
    }
