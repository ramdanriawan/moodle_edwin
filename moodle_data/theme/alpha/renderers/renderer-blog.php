...
class theme_alpha_core_blog_renderer extends core_blog_renderer {
   ...
   public function render_blog_entry(blog_entry $entry) {
       ...
       if ($entry->renderable->usercanedit) {
           ...
           if (empty($entry->uniquehash)) {
               ...
               $o .= html_writer::link(new moodle_url('/blog/edit.php',
                                                       ...
                                                       $icon, array('class'=>'btn btn-sm btn-secondary'));
           }
           $icon = '<svg width="24" height="24" fill="none" viewBox="0 0 24 24">
           ...
           $o .= html_writer::link(new moodle_url('/blog/edit.php',
                                                   ...
                                                   $icon, array('class'=>'btn btn-sm btn-danger'));
       }
       ...
       $o .= html_writer::link($entryurl, $icon, array('class'=>'btn btn-sm btn-outline-secondary'));
