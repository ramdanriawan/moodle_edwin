...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_alpha/drawers:show}
     * @property {String} drawerShown See {@link event:theme_alpha/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_alpha/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_alpha/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_alpha/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_alpha/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_alpha/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_alpha/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_alpha/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_alpha/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_alpha/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_alpha/drawers:hidden',
    };
     ...
     * @returns {module:theme_alpha/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_alpha/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_alpha/drawers:close');
     ...
     *
     * @param {module:theme_alpha/drawers} comparisonInstance
     */
