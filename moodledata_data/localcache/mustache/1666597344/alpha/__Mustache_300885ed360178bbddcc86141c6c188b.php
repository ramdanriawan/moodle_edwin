...
class __Mustache_300885ed360178bbddcc86141c6c188b extends Mustache_Template
{
...
';
        $buffer .= $indent . '>
';
        $buffer .= $indent . '    <div class="card-header px-1 py-1 d-flex justify-content-between flex-shrink-0">
';
        $buffer .= $indent . '        <button
';
        $buffer .= $indent . '            class="btn btn-sm btn-secondary icon-no-margin category-button selected"
';
...
';
        $buffer .= $indent . '        <button
';
        $buffer .= $indent . '            class="btn btn-sm btn-secondary icon-no-margin category-button"
';
        $buffer .= $indent . '            data-action="show-category"
';
...
';
        $buffer .= $indent . '        <button
';
        $buffer .= $indent . '            class="btn btn-secondary icon-no-margin category-button mr-1"
';
        $buffer .= $indent . '            data-action="show-category"
';
...
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <div class="card-body p-2 mb-0 d-flex flex-column overflow-hidden">
';
...
';
        $buffer .= $indent . '                class="form-control rui-message-search-input"
';
