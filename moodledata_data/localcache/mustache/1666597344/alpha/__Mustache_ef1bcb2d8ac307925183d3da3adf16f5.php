...
class __Mustache_ef1bcb2d8ac307925183d3da3adf16f5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<label class="form-check ';
        ...
        $buffer .= '">
';
        $buffer .= $indent . '    <label class="d-inline-flex custom-control ios-switch">
';
        $value = $context->findDot('element.hardfrozen');
        if (empty($value)) {
            
            $value = $context->findDot('element.frozen');
            $buffer .= $this->section7efd679b9b797816650d90567f8e4c2d($context, $indent, $value);
        }
        $buffer .= $indent . '    <input type="checkbox" name="';
        $value = $this->resolveValue($context->findDot('element.name'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '" class="form-check-input ios-switch-control-input ';
        $value = $this->resolveValue($context->findDot('element.extraclasses'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '"
';
...
';
        ...
        $buffer .= $this->section1fe1520386f4176e58e967090cd6523b($context, $indent, $value);
        $value = $context->findDot('element.value');
        if (empty($value)) {
...
';
        ...
        $value = $context->findDot('element.frozen');
        $buffer .= $this->section897f7fdd276e80570e88919aca756f81($context, $indent, $value);
        $buffer .= $indent . '        ';
...
';
        $buffer .= $indent . '        <span class="ios-switch-label">';
...
';
    ...
    private function section7efd679b9b797816650d90567f8e4c2d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section1fe1520386f4176e58e967090cd6523b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section897f7fdd276e80570e88919aca756f81(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
