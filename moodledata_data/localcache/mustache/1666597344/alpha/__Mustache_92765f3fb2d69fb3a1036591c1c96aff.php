...
class __Mustache_92765f3fb2d69fb3a1036591c1c96aff extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<div class="form-checkbox defaultsnext custom-controls-stacked mr-2">
';
        $buffer .= $indent . '    <label class="custom-control ios-switch mb-0">
';
...
';
        ...
        $buffer .= '>
';
        $buffer .= $indent . '        <span class="ios-switch-control-indicator mx-0"></span>
';
        $buffer .= $indent . '    </label>
';
        $buffer .= $indent . '</div>';
