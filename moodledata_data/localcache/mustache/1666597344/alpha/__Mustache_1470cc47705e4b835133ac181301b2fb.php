...
class __Mustache_1470cc47705e4b835133ac181301b2fb extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section35cde14d4f8fea37f46d2e4768ad4be5($context, $indent, $value);
...
';
    ...
    private function sectionC6fe6af14e1bc5d0d5c475e4c980bb1b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'currentinparentheses, theme_alpha';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
            foreach ($values as $value) {
                ...
                $buffer .= 'currentinparentheses, theme_alpha';
                $context->pop();
            }
        }
    ...
    private function sectionB51530177f5fde57f6da7db1c7b6766e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                            <span class="sr-only">{{#str}}currentinparentheses, theme_alpha{{/str}}</span>
                        ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                            <span class="sr-only">';
                $value = $context->find('str');
                $buffer .= $this->sectionC6fe6af14e1bc5d0d5c475e4c980bb1b($context, $indent, $value);
                $buffer .= '</span>
';
                $context->pop();
            }
    ...
    private function section86ae4a26197a34cff44d5eff5bab540c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $value = $context->find('active');
                $buffer .= $this->sectionB51530177f5fde57f6da7db1c7b6766e($context, $indent, $value);
                $buffer .= $indent . '                    </a>
';
                $buffer .= $indent . '                </li>
';
...
';
    ...
    private function section35cde14d4f8fea37f46d2e4768ad4be5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section86ae4a26197a34cff44d5eff5bab540c($context, $indent, $value);
