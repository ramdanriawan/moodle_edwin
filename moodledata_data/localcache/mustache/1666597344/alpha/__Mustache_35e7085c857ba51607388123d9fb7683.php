...
class __Mustache_35e7085c857ba51607388123d9fb7683 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section1bf83e12c7f9ed67b5ce149d9f11d88f($context, $indent, $value);
        $value = $context->find('displaygroupingselector');
        if (empty($value)) {
...
';
    ...
    private function section1bf83e12c7f9ed67b5ce149d9f11d88f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div class="dropdown mb-1 mr-auto">
    <button id="groupingdropdown" type="button" class="btn btn-sm btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="{{#str}} aria:groupingdropdown, block_myoverview {{/str}}">
        ...
        <span class="btn--title d-none d-md-inline-block ml-2" data-active-item-text>
...
';
                $buffer .= $indent . '    <button id="groupingdropdown" type="button" class="btn btn-sm btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="';
                $value = $context->find('str');
...
';
                $buffer .= $indent . '        </svg>
';
                $buffer .= $indent . '        <span class="btn--title d-none d-md-inline-block ml-2" data-active-item-text>
';
                $buffer .= $indent . '            ';
                $value = $context->find('allincludinghidden');
