...
class __Mustache_c280185a4815d06af499f2d71d94f4b7 extends Mustache_Template
{
...
';
        ...
        $buffer .= '" aria-controls="menudayfilter" title="';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '        </svg>
';
        $buffer .= $indent . '        <span id="timeline-day-filter-current-selection" data-active-item-text class="ml-2">
';
        $buffer .= $indent . '            ';
