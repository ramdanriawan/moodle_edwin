...
class __Mustache_36157d981197589012e14d523f661e2e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9ff6b76659cf7ce5105acc218ef71a05($context, $indent, $value);
        $value = $context->find('component');
        if (empty($value)) {
...
';
    ...
    private function section9ff6b76659cf7ce5105acc218ef71a05(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<span class="d-inline-flex align-items-center inplaceeditable inplaceeditable-{{type}}" data-inplaceeditable="1" data-component="{{component}}" data-itemtype="{{itemtype}}" data-itemid="{{itemid}}"
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<span class="d-inline-flex align-items-center inplaceeditable inplaceeditable-';
...
';
                ...
                $buffer .= '
';
                $buffer .= $indent . '        <a href="#" class="quickeditlink aalink mx-2" data-inplaceeditablelink="1" title="';
