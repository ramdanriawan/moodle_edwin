...
class __Mustache_e3c7572c2d84acbcd12ae46bdff64e04 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="form-group row px-0 ';
...
';
        ...
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <div class="col-sm-12 col-md-9 checkbox px-0">
';
        $buffer .= $indent . '        <div class="form-check form-checkbox defaultsnext custom-controls-stacked">
';
        $buffer .= $indent . '            <label class="custom-control ios-switch">
';
...
';
        $buffer .= $indent . '            </label>
';
        $buffer .= $indent . '            <span class="text-nowrap" style="line-height: 1">
';
        $buffer .= $indent . '                ';
        $value = $context->find('advanced');
        $buffer .= $this->section1b94454cc2385462d5ebf5808cfadf4f($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '                ';
...
';
        $value = $context->find('error');
        $buffer .= $this->sectionC89e112387eb8a0dda6056344ecd73de($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section1b94454cc2385462d5ebf5808cfadf4f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '<span class="initialism text-info" title="{{#str}}advanced{{/str}}">!</span>';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
            foreach ($values as $value) {
                ...
                $buffer .= '<span class="initialism text-info" title="';
    ...
    private function sectionC89e112387eb8a0dda6056344ecd73de(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
