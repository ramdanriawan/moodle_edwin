...
class __Mustache_58381bf9231337f8568cc4bb88aaece9 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                                    <a href="#" class="btn btn-secondary btn-icon">';
...
';
        ...
        $buffer .= '" class="btn btn-secondary btn-icon" href="#">
';
...
';
        ...
        $buffer .= '" class="btn btn-danger btn-icon" href="#">
';
...
';
        ...
        $buffer .= '" class="fp-vb-icons btn btn-secondary btn-icon" href="#">
';
...
';
        ...
        $buffer .= '" class="fp-vb-details btn btn-secondary btn-icon" href="#">
';
...
';
        ...
        $buffer .= '" class="fp-vb-tree btn btn-secondary btn-icon" href="#">
';
        $buffer .= $indent . '                                <svg width="26" height="26" fill="none" viewBox="0 0 24 24">
';
