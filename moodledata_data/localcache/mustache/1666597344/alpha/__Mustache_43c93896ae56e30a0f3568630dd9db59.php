...
class __Mustache_43c93896ae56e30a0f3568630dd9db59 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="form-group table-responsive">
';
        $buffer .= $indent . '    <table id="emoticonsetting" class="admintable table table-hover">
';
