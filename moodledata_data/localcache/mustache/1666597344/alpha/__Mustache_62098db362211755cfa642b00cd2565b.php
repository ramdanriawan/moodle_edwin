...
class __Mustache_62098db362211755cfa642b00cd2565b extends Mustache_Template
{
...
';
        ...
        $buffer .= '">
';
        $buffer .= $indent . '        <div class="d-inline-flex justify-content-between flex-wrap w-100">
';
        ...
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        <div class="mt-2 w-100">
';
