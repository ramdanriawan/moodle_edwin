...
class __Mustache_8db09a5c356347e88dea4ce271e1a535 extends Mustache_Template
{
...
';
        ...
        $buffer .= '</label>
';
        $buffer .= $indent . '                    <div class="col"><input type="text" class="form-control"/></div>
';
        $buffer .= $indent . '                </div>
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '        <button class="fp-upload-btn btn btn-primary">';
        $value = $context->find('str');
