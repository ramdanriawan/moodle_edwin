...
class __Mustache_f2037bd8119f8067eeada1a3d33c1365 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<div class="p-3 bg-white rounded" data-region="confirm-dialogue" role="alert">
';
        $buffer .= $indent . '    <h3 class="h6 hidden" data-region="dialogue-header"></h3>
';
        $buffer .= $indent . '    <p data-region="dialogue-text"></p>
';
        $buffer .= $indent . '    <div class="p-0 mb-2 custom-control custom-checkbox hidden" data-region="delete-messages-for-all-users-toggle-container">
';
...
';
        $buffer .= $indent . '                    id="delete-messages-for-all-users" data-region="delete-messages-for-all-users-toggle"
';
        $buffer .= $indent . '                >
';
        $buffer .= $indent . '                <span class="ios-switch-control-indicator"></span>
';
        $buffer .= $indent . '                <label class="my-0" for="delete-messages-for-all-users">
';
        $buffer .= $indent . '                    ';
...
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <button type="button" class="mx-0 btn btn-danger btn-block hidden" data-action="confirm-block">
';
...
';
        $buffer .= $indent . '    <button type="button" class="mx-0 btn btn-success btn-block hidden" data-action="confirm-unblock">
';
        $buffer .= $indent . '        <span data-region="dialogue-button-text">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '    </button>
';
        $buffer .= $indent . '    <button type="button" class="mx-0 btn btn-danger btn-block hidden" data-action="confirm-remove-contact">
';
        $buffer .= $indent . '        <span data-region="dialogue-button-text">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '    </button>
';
        $buffer .= $indent . '    <button type="button" class="mx-0 btn btn-success btn-block hidden" data-action="confirm-add-contact">
';
        $buffer .= $indent . '        <span data-region="dialogue-button-text">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '    </button>
';
        $buffer .= $indent . '    <button type="button" class="mx-0 btn btn-danger btn-block hidden" data-action="confirm-delete-selected-messages">
';
        $buffer .= $indent . '        <span data-region="dialogue-button-text">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '    </button>
';
        $buffer .= $indent . '    <button type="button" class="mx-0 btn btn-danger btn-block hidden" data-action="confirm-delete-conversation">
';
        $buffer .= $indent . '        <span data-region="dialogue-button-text">';
        $value = $context->find('str');
        $buffer .= $this->section64172922a3e0de72f74333365d6d5705($context, $indent, $value);
...
';
        $buffer .= $indent . '    </button>
';
        $buffer .= $indent . '    <button type="button" class="mx-0 btn btn-primary btn-block hidden" data-action="request-add-contact">
';
        $buffer .= $indent . '        <span data-region="dialogue-button-text">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '    </button>
';
        $buffer .= $indent . '    <button type="button" class="mx-0 btn btn-primary btn-block hidden" data-action="accept-contact-request">
';
        $buffer .= $indent . '        <span data-region="dialogue-button-text">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '    </button>
';
        $buffer .= $indent . '    <button type="button" class="mx-0 btn btn-danger btn-block hidden" data-action="decline-contact-request">
';
        $buffer .= $indent . '        <span data-region="dialogue-button-text">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '    </button>
';
        $buffer .= $indent . '    <button type="button" class="mx-0 btn btn-primary btn-block" data-action="okay-confirm">';
        $value = $context->find('str');
        $buffer .= $this->section8328a7430a286b60056ca505dabcef89($context, $indent, $value);
        $buffer .= '</button>
';
        $buffer .= $indent . '    <button type="button" class="mx-0 btn btn-secondary btn-block" data-action="cancel-confirm">';
        $value = $context->find('str');
