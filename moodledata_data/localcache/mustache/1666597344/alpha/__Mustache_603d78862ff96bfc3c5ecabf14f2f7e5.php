...
class __Mustache_603d78862ff96bfc3c5ecabf14f2f7e5 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <a href="#" data-route="view-contacts" role="button" class="btn-msg-special">
';
        $buffer .= $indent . '      <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
';
