...
class __Mustache_c582616822132379054220204880e740 extends Mustache_Template
{
...
';
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_view_overview_section')) {
            $context->pushBlockContext(array(
                ...
                'emptymessage' => array($this, 'block1839466d3362a5000f86aaa8bf8faf1f'),
            ));
...
';
    ...
    public function block1839466d3362a5000f86aaa8bf8faf1f($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . '        <p>';
        $value = $context->find('str');
