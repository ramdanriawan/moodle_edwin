...
class __Mustache_1d97887545d9e9906d869c1db451ec6f extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="popover-region-toggle rui-topbar-special-btn"
';
...
';
        ...
        if (is_callable($blockFunction)) {
            ...
            $buffer .= $this->section9d62a7adcbeada16a458cac6239a5fd1($context, $indent, $value);
        }
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>
';
    ...
    private function section9d62a7adcbeada16a458cac6239a5fd1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <a class="see-all-link d-inline-flex align-items-center w-100 justify-content-end"
                    href="{{{.}}}">
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                <a class="see-all-link d-inline-flex align-items-center w-100 justify-content-end"
';
                $buffer .= $indent . '                    href="';
...
';
                ...
                $buffer .= '
';
                $buffer .= $indent . '                    <svg class="ml-2" width="20" height="20" fill="none" viewBox="0 0 24 24">
';
