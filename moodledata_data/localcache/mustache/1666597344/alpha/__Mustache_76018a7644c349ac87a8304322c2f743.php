...
class __Mustache_76018a7644c349ac87a8304322c2f743 extends Mustache_Template
{
...
';
        $buffer .= $indent . '>
';
        $buffer .= $indent . '    <div class="hidden px-3" data-region="search-results-container" style="overflow-y: auto">
';
...
';
        ...
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <div class="rui-message-container-md mt-3" data-region="empty-message-container">
';
        $buffer .= $indent . '        <p class="small text-muted">';
