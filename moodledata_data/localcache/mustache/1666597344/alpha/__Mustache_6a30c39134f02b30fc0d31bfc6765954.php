...
class __Mustache_6a30c39134f02b30fc0d31bfc6765954 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block6e2249456bc4618cf082f6a88014de9c'),
            ));
...
';
    ...
    public function block6e2249456bc4618cf082f6a88014de9c($context)
    {
        $indent = $buffer = '';
...
';
        $buffer .= $indent . '            </a>
';
        $buffer .= $indent . '            <span data-passwordunmask="instructions" class="badge badge-info ml-2" style="display: none;">
';
        $value = $context->findDot('element.frozen');
        if (empty($value)) {
