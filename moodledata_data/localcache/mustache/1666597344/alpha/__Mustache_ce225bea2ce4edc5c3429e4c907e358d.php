...
class __Mustache_ce225bea2ce4edc5c3429e4c907e358d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0e0c9671ada413bd7f0658ef326b6fa7($context, $indent, $value);
        $buffer .= $indent . '        </tbody>
';
        $buffer .= $indent . '    </table>
';
...
';
    ...
    private function sectionAa6d0bf1e35dccb3e5b759a2e72c2784(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                                                    <div class="d-inline-flex align-items-center flex-wrap small mb-2">
                                                        {{{course.fullname}}}
                                                    </div>
                                                    ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                                                    <div class="d-inline-flex align-items-center flex-wrap small mb-2">
';
                $buffer .= $indent . '                                                        ';
...
';
    ...
    private function section1450209006deb3bf2a9beb8533816e96(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
                                        ...
                                        {{^underway}}
                                            <li 
                                                class="calendar_event_{{calendareventtype}}"
                                                ...
                                                <a data-action="view-event" data-event-id="{{id}}" href="{{url}}" title="{{name}}">
                                                    ...
                                                    {{/course.fullname}}
                                                    <div class="d-block event-time my-2">{{{formattedtime}}}</div>
...
';
                    ...
                    $buffer .= $this->sectionAa6d0bf1e35dccb3e5b759a2e72c2784($context, $indent, $value);
                    $buffer .= $indent . '                                                    <div class="d-block event-time my-2">';
                    $value = $this->resolveValue($context->find('formattedtime'), $context);
                    $buffer .= ($value === null ? '' : $value);
                    $buffer .= '</div>
';
                    $buffer .= $indent . '                                                    <span class="event-title">';
                    $value = $this->resolveValue($context->find('name'), $context);
                    $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                    $buffer .= '</span>
';
...
';
    ...
    private function section83ac711b53641bacca3ad85d7e1a883f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section1450209006deb3bf2a9beb8533816e96($context, $indent, $value);
...
';
    ...
    private function section407907beebb784976ac4827c525700cd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $value = $context->find('hasevents');
                $buffer .= $this->section83ac711b53641bacca3ad85d7e1a883f($context, $indent, $value);
                $buffer .= $indent . '                        </div>
';
...
';
    ...
    private function section0e0c9671ada413bd7f0658ef326b6fa7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section407907beebb784976ac4827c525700cd($context, $indent, $value);
